...
<div class="container auth-wrap">
    <div class="row g-4 align-items-center">
        <div class="col-lg-6 hero-copy">
            ...
            <p class="fs-5 text-muted mb-4">CampusConnect gives your class, organization, or campus community one place to post updates, react, and connect in real time.</p>
            ...
            <div class="check-list">
                <div class="check-item">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Add your name, username, and identity before joining the feed.</small>
                    </div>
                </div>
                <div class="check-item">
                    <i class="bi bi-check2-circle fs-5"></i>
                    <div>
                        ...
                        <small class="text-muted">Posts, comments, likes, and messaging are ready right after signup.</small>
                    </div>
                </div>
                <div class="check-item">
                    <i class="bi bi-check2-circle fs-5"></i>
                    <div>
                        ...
                        <small class="text-muted">The app is structured to demo the main CRUD features smoothly.</small>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="auth-panel p-4 p-md-5">
                <div class="mb-4">
                    ...
                    <p class="mb-0 text-muted">Start building your profile and join the conversation.</p>
                </div>
                ...
                <form method="POST" novalidate>
                    ...
                    <button class="btn btn-primary w-100 fw-semibold py-3">Register</button>
                </form>

                <p class="text-center mt-4 mb-0">
                    Already have an account?
                    <a href="index.php?action=login" class="fw-semibold">Log in</a>
                </p>
            </div>
        </div>
    </div>
